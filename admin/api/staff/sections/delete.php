...
if ($requestMethod === 'POST') {
    ...
    try {
        $deleteFieldsSql = "DELETE FROM `staff_form_fields` WHERE `inst_id`='$instituteId' AND `section_id`='$sectionId'";
        ...
        $deleteSectionSql = "DELETE FROM `staff_form_sections` WHERE `id`='$sectionId' AND `inst_id`='$instituteId' AND `form_section`='$section'";
