...
if ($requestMethod === 'GET') {
    ...
    $subjectCondition = "";
    if (!empty($subject)) {
        // Support comma-separated subjects (e.g. "Science,English" or "Science, English").
        // Wrap value in commas after stripping spaces around delimiters, then do a comma-bounded LIKE match.
        $subjectCondition = " AND REPLACE(CONCAT(',', sfv.value, ','), ', ', ',') LIKE '%,$subject,%' ";
    }
