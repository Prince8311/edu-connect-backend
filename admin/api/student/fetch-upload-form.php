...
if ($requestMethod === 'GET') {
    ...
    $sql = "SELECT s.id AS section_id, s.form_section, f.id AS field_id, f.form_field, f.field_type, f.is_required, f.items FROM student_form_sections s LEFT JOIN student_form_fields f ON s.id = f.section_id AND s.inst_id = f.inst_id WHERE (s.inst_id = '$instituteId' OR s.inst_id IS NULL) ORDER BY s.id ASC, f.sort_order ASC";
