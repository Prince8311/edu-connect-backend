                                            ...
                                            <body style="position: relative;">
                                                <div style="position: relative; width: 100%;">
                                                    <div style="position: relative; background: #FFF; padding: 25px; border-radius: 10px; text-align: center;">
                                                        ...
                                                        <div style="position: relative; width: 300px; padding: 20px; margin: 0 auto; margin-top: 25px; background-color: #FFF;  border-radius: 10px; box-shadow: 0 0 10px rgba(126, 126, 126, 0.3);">
                                                            <div style="position: relative; font-size: 18px; font-weight: 500;">Registration Request Received</div>
                                                            <div class="poppins-font" style="position: relative; font-size: 13px; margin-top: 10px; color: #838383; line-height: 1.3;">Thank you for starting your digital transformation with <span class="poppins-font" style="color: #1c41ff; font-weight: 500;">Edu Connekt</span> </div>. Your request for <span class="poppins-font" style="color: #02c0ff; font-weight: 500;">' . $institutionName . '</span> has been successfully listed in our system. Our team is currently reviewing your application for administrative approval.</div>
